...
def BuildPYG(adata, subgraphs):
    ...
    # Get library size from adata
    library_size = adata.obs['nCount_RNA'].values
    ...
    for subgraph in subgraphs:
        ...
        # Get library size for these nodes
        node_library_size = library_size[node_indices]
        ...
        ptg_data.library_size = torch.tensor(node_library_size, dtype = torch.float)
        ## Add node indices
